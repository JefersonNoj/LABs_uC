...
loop:
    ;BTFSC ((INTCON) and 07Fh), 2 ; evaluar bandera de overflow para TMR0
    ;CALL inc_portA
    BTFSC PORTB, 0
    CALL inc_portC
    BTFSC PORTB, 1
...
reset_tmr0:
    MOVLW 231
    MOVWF TMR0
    BCF ((INTCON) and 07Fh), 2 ; Apagar bandera de overflow para TMR0
    RETURN

config_clk:
    BANKSEL OSCCON
    BCF ((OSCCON) and 07Fh), 6 ; IRCF/010/250kHz (frecuencia de oscilación)
...
config_io:
    ...
    CLRF ANSELH
    BANKSEL TRISA
    BCF TRISA, 0 ; ((PORTA) and 07Fh), 0 como salida
    BCF TRISA, 1 ; ((PORTA) and 07Fh), 1 como salida
    BCF TRISA, 2 ; ((PORTA) and 07Fh), 2 como salida
    BCF TRISA, 3 ; ((PORTA) and 07Fh), 3 como salida
    CLRF TRISC
...
tabla:
    ...
    BSF PCLATH, 0 ; Posicionamos el PC
    ANDLW 0xF
    ADDWF PCL ;
    RETLW 00111111B
    RETLW 00000110B
